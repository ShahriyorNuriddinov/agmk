...
export default function SalaryPage() {
    ...
    const stats = [
        {
            label: "Оклад",
            value: salary ? `${salary.baseSalary.toLocaleString()} сум` : "—",
            icon: DollarSign,
            trend: null,
        },
        {
            label: "Премии",
            value: salary ? `${salary.totalIncome.toLocaleString()} сум` : "—",
            icon: BarChart3,
            trend: null,
        },
        {
            label: "Удержания",
            value: salary ? `${salary.totalDeductions.toLocaleString()} сум` : "—",
            icon: PieChart,
            trend: null,
        },
        {
            label: "К выплате",
            value: salary ? `${salary.netSalary.toLocaleString()} сум` : "—",
            icon: Calendar,
            trend: null,

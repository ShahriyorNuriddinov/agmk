            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-xl border shadow-sm p-8">
                    ...
                    <div className="flex rounded-lg border overflow-hidden mb-6">
                        ...
                        <button
                            type="button"
                            onClick={() => { setTab("otp"); setOtpStep("email"); setOtpError(""); }}
                        ...
                        <form onSubmit={passForm.handleSubmit((d) => mutate(d))} className="space-y-4">
                            <div>
                                ...
                                {passForm.formState.errors.email && (
                                    <p className="text-xs text-destructive mt-1">{passForm.formState.errors.email.message}</p>
                                )}
                            </div>
                            <div>
                                ...
                                {passForm.formState.errors.password && (
                                    <p className="text-xs text-destructive mt-1">{passForm.formState.errors.password.message}</p>
                                )}
                            </div>
                            <button
                                type="submit"
                        ...
                        <form onSubmit={codeForm.handleSubmit(verifyOtp)} className="space-y-4">
                            ...
                            <div>
                                ...
                                {codeForm.formState.errors.code && (
                                    <p className="text-xs text-destructive mt-1">{codeForm.formState.errors.code.message}</p>
                                )}
                            </div>
                            {otpError && <p className="text-xs text-destructive">{otpError}</p>}
                            <button
                            ...
                            <button
                                type="button"
                                onClick={() => { setOtpStep("email"); setOtpError(""); codeForm.reset(); }}
